...
JNICALL
Java_com_droidteahouse_cooperhewitt_ui_ArtActivity_stringFromJNI(
    JNIEnv *env,
    jobject /* this */) {
...
JNICALL
Java_com_droidteahouse_cooperhewitt_ui_ArtActivity_hashFromJNI(
    JNIEnv *env,
    jobject /* this */) {
...
JNICALL
Java_com_droidteahouse_cooperhewitt_ListPreloaderHasher_hashBitmap(JNIEnv *env, jobject obj, jarray pixels) {
